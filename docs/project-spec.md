...
- Starting card subtitle/body size defaults:
- Body maximum line count:
- Image style:
- Layout preferences:
- Logo or watermark rules:
- Margins / safe areas:
- Background rules:
- Visual template path:
...
- Explicit anti-patterns:
  - slide counters unless explicitly enabled
  - main text inside a generic box/panel unless explicitly enabled
  - random metadata/footer labels unless explicitly enabled
